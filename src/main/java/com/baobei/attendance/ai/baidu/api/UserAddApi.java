 ...
 */
@Component
public class UserAddApi extends Api<UserAddApi.UserAddReq, UserAddApi.UserAddRes> {
    public UserAddApi() {
        super();
    ...
    public static class UserAddReq extends BaseReq {
        /**
    ...
    @ToString(callSuper = true)
    @EqualsAndHashCode(callSuper = true)
    public static class UserAddRes extends BaseRes {
