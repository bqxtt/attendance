...
import com.baobei.attendance.ai.baidu.api.entity.Location;
import lombok.Data;
 ...
 */
@Component
public class MultiSearchApi extends Api<MultiSearchApi.MultiSearchReq, MultiSearchApi.MultiSearchRes> {
    ...
    public static class MultiSearchReq extends BaseReq {
        /**
    ...
    @ToString(callSuper = true)
    @EqualsAndHashCode(callSuper = true)
    public static class MultiSearchRes extends BaseRes {
